						...
						<div class="box alt">
								...
								<section class="col-4 col-6-medium col-12-xsmall">
									<span class="icon alt major fa-area-chart"></span>
										...
										<ul class="actions stacked">
											<li><a href="add_user.php" class="button primary">Go To ADD User</a></li>
										</ul>
								</section>
								<section class="col-4 col-6-medium col-12-xsmall">
									<span class="icon alt major fa-comment"></span>
										<h3>delete user</h3>
										<ul class="actions stacked">
											<li><a href="delete_user.php" class="button primary">Go To Delete User</a></li>
										</ul>
								</section>
								<section class="col-4 col-6-medium col-12-xsmall">
							...
							<!--	<section class="col-4 col-6-medium col-12-xsmall">
									...
									<h3>Create Department</h3>
										<ul class="actions stacked">
											<li><a href="#" class="button primary">Go To Create Department</a></li>
										</ul>
								</section>
								<section class="col-4 col-6-medium col-12-xsmall">
